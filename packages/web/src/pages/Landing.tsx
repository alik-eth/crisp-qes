        ...
        <section>
            ...
            <div className="about-section-block">
                ...
                <div className="mech-grid-3" style={{ marginTop: 56 }}>
                    ...
                    <div className="how-card">
                        <span className="how-card__n mono">FHE · {i18n.language === "uk" ? "У ПЛАНАХ" : "ROADMAP"}</span>
                        <h3 className="how-card__title">{i18n.language === "uk" ? "Зашифрований підрахунок" : "Encrypted tally"}</h3>
                        <p className="how-card__body">{i18n.language === "uk" ? "У дорожній карті: гомоморфне шифрування через комітет Interfold (CRISP) шифруватиме самі голоси й розкриватиме лише підсумок — щоб приховати не тільки особу, а й те, як саме розподілилися голоси. Сьогодні підрахунок прозорий, на блокчейні." : "On the roadmap: homomorphic encryption via Interfold's committee (CRISP) will encrypt the votes themselves and reveal only the aggregate — hiding not just who you are but how the votes split. Today the count is a transparent on-chain counter."}</p>
                    </div>
                </div>
            </div>
