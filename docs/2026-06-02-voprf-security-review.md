...
- `enroll_commit_v2` messageDigest read from a free offset without attribute-OID/contentType/uniqueness check — flagged as enrollment hygiene; not in the confirmed critical set.
